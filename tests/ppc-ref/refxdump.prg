...
//
// O __DIM e' identidade aqui (como o __FP_DIM escalar do `#xtranslate __FP_DIM` do hbfoxpro.ch), para o
// .ppo mostrar o guarda SUMINDO e deixando o `PUBLIC nA, nB` intacto, sem ruido.
//
// O QUE ESTE ARQUIVO ANCORA (guarda corpus_ref):
//   - .ppo: o <@> some antes do compilador (hb_pp_tokenGet no ppcore.c, o token reference e'
...
//     (text '~', col null; hb_pp_resultMarkerNew no ppcore.c) -- nao e' marker que se nomeia, e' um sinal.
