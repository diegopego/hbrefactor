...
## [arquivadas] Fases W e X — isolamento do trabalho e procedência do dump (2026-08-06/07)

*Migradas verbatim do roadmap.md ao concluir. A fase V continua ATIVA e depende do que
está aqui: a fatia 2 dela (fato analisado incremental) começa do fato que a X entregou.*
