...
| `corpus_metodo` | selo `METODO-V2` nas revisadas; **selo sem prova reprova** | **18 revisadas · 9 pendentes** (nomeadas; revisadas 2026-07-15: `ppc-ref`, `ppc-store`, `ppc-say`, `ppc-set`) |
