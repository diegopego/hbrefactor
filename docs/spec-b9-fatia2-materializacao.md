...
| membro JÁ declarado ganhando retorno (fixb7b q1 `Pega`/`Soma`) | **DESBLOQUEADA (candidato (g) ADOTADO, core `b758cf376a`)**: `_HB_MEMBER <M>() AS CLASS <C>` repetido faz o merge (hbmain.c:1178) e o W0019 já não dispara em complemento de tipo (hbmain.c:1174-1180); topologia (g) vira nível 2 normal | probg/probg2 + pg1-pg5b |
